# 1 "../../../../../../kernel/freertos/dpl/MutexP_freertos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
...
# 39 "../../../../../../kernel/freertos/dpl/MutexP_freertos.c" 2
...
# 40 "../../../../../../kernel/freertos/dpl/MutexP_freertos.c" 2
...
MutexP_Handle MutexP_construct(MutexP_Struct *handle, MutexP_Params *params)
{
    ...
    sem = xQueueCreateMutexStatic( ( ( uint8_t ) 4U ), (StaticSemaphore_t *)handle );
...
MutexP_Handle MutexP_create(MutexP_Params *params)
{
    ...
    sem = xQueueCreateMutex( ( ( uint8_t ) 4U ) );
...
uintptr_t MutexP_lock(MutexP_Handle handle)
{
    ...
    while (xQueueTakeMutexRecursive( ( xMutex ), ( (TickType_t)10 ) ) == ( ( BaseType_t ) 0 )) {
        ;
    }
