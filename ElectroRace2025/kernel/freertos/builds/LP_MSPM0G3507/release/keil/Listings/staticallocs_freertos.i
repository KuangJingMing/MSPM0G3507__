# 1 "../../../../../../kernel/freertos/dpl/StaticAllocs_freertos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../../kernel/freertos/dpl/StaticAllocs_freertos.c" 2
# 35 "../../../../../../kernel/freertos/dpl/StaticAllocs_freertos.c"
...
# 36 "../../../../../../kernel/freertos/dpl/StaticAllocs_freertos.c" 2
...
# 37 "../../../../../../kernel/freertos/dpl/StaticAllocs_freertos.c" 2
                                    ...
                                    uint32_t *pulTimerTaskStackSize)
{
    ...
    static StackType_t uxTimerTaskStack[(((unsigned short) 128))];

    *ppxTimerTaskTCBBuffer = &xTimerTaskTCB;
    *ppxTimerTaskStackBuffer = uxTimerTaskStack;
    *pulTimerTaskStackSize = (((unsigned short) 128));
}
