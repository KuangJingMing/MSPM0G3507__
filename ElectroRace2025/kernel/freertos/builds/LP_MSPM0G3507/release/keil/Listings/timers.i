# 1 "../../../../../../kernel/freertos/Source/timers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../../../../kernel/freertos/Source/timers.c" 2
# 28 "../../../../../../kernel/freertos/Source/timers.c"
...
# 29 "../../../../../../kernel/freertos/Source/timers.c" 2
...
# 36 "../../../../../../kernel/freertos/Source/timers.c" 2
...
# 37 "../../../../../../kernel/freertos/Source/timers.c" 2
...
# 38 "../../../../../../kernel/freertos/Source/timers.c" 2
...
# 39 "../../../../../../kernel/freertos/Source/timers.c" 2
# 72 "../../../../../../kernel/freertos/Source/timers.c"
...
# 134 "../../../../../../kernel/freertos/Source/timers.c"
...
# 151 "../../../../../../kernel/freertos/Source/timers.c"
...
# 263 "../../../../../../kernel/freertos/Source/timers.c"
        }
        else
        {
                                    ;
        ...
        if ((xReturn) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
        return xReturn;
    }
                                          ...
                                          StaticTimer_t * pxTimerBuffer )
        {
            Timer_t * pxNewTimer;
...

                {
                    ...
                    if ((xSize == sizeof( Timer_t )) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
                    ( void ) xSize;
                }



            if ((pxTimerBuffer) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
                                       ...
                                       Timer_t * pxNewTimer )
    {
        ...
        if ((( xTimerPeriodInTicks > 0 )) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
                                     ...
                                     const TickType_t xTicksToWait )
    {
        ...
        if ((xTimer) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
    ...
    TaskHandle_t xTimerGetTimerDaemonTaskHandle( void )
    {
        ...
        if ((( xTimerTaskHandle != 0 )) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
                                        ...
                                        const TickType_t xTimeNow )
    {
        ...
        if( ( pxTimer->ucStatus & ( ( uint8_t ) 0x04 ) ) != 0 )
        {
            ...
            if( prvInsertTimerInActiveList( pxTimer, ( xNextExpireTime + pxTimer->xTimerPeriodInTicks ), xTimeNow, xNextExpireTime ) != ( ( BaseType_t ) 0 ) )
            {
                ...
                if ((xResult) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
                ( void ) xResult;
            }
            else
            {
    ...
    static void prvTimerTask( void * pvParameters )
    {
        ...
        ( void ) pvParameters;
# 571 "../../../../../../kernel/freertos/Source/timers.c"
        for( ; ; )
        {
    ...
    {
        TickType_t xNextExpireTime;
# 660 "../../../../../../kernel/freertos/Source/timers.c"
    ...
    static void prvProcessReceivedCommands( void )
    {
        ...
        {
# 776 "../../../../../../kernel/freertos/Source/timers.c"
            if( xMessage.xMessageID >= ( BaseType_t ) 0 )
            {
                ...
                if( ( ( ( &( pxTimer->xTimerListItem ) )->pxContainer == ( 0 ) ) ? ( ( ( BaseType_t ) 1 ) ) : ( ( ( BaseType_t ) 0 ) ) ) == ( ( BaseType_t ) 0 ) )
                {
                ...
                switch( xMessage.xMessageID )
                {
                    ...
                    case ( ( BaseType_t ) 9 ):
                        ...
                        if ((( pxTimer->xTimerPeriodInTicks > 0 )) == 0) { __asm volatile ( " cpsid i " ::: "memory" ); for (;;) ; };
...
# 882 "../../../../../../kernel/freertos/Source/timers.c"
                        break;
            ...
            if( xTimerQueue == 0 )
            {
                ...
                pxOverflowTimerList = &xActiveTimerList2;
...

                    {
                                        ...
                                        static uint8_t ucStaticTimerQueueStorage[ ( size_t ) (20) * sizeof( DaemonTaskMessage_t ) ];

                        xTimerQueue = xQueueGenericCreateStatic( ( ( UBaseType_t ) (20) ), ( ( UBaseType_t ) sizeof( DaemonTaskMessage_t ) ), ( &( ucStaticTimerQueueStorage[ 0 ] ) ), ( &xStaticTimerQueue ), ( ( ( uint8_t ) 0U ) ) );
                    }
# 994 "../../../../../../kernel/freertos/Source/timers.c"
            }
            else
            {
                                        ;
...
# 1122 "../../../../../../kernel/freertos/Source/timers.c"
        UBaseType_t uxTimerGetTimerNumber( TimerHandle_t xTimer )
        {
